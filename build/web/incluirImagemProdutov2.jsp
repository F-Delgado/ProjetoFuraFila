...
<html lang="pt-BR">
    ...
    <body onload="validaStatus()" style="max-width: 100%; overflow: hidden; background-color: #a1c2de">
        ...
        <form  method = "POST"
            ...
            <input type = "submit" value = "Enviar Imagem" onclick="teste()" class="btn btn-primary rounded-pill btn-outline-light my-2 my-sm-0"/>
        </form>
        <script>
            ...
            function teste() {
                ...
                url = "receberDadosImgProdutov2.jsp?cod=" + cod
