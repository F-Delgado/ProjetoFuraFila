        ...
        <div>
            <div class="consulta" 
                ...
                <form  class="forms" action="receberDadosVenda.jsp" method="POST"> 
                    ...
                    <input type="submit" class="btn btn-primary rounded-pill" value="Consultar">
                </form>
            </div>
                            ...
                            <div id="header">
                                ...
                                <div id="header">
                                    <div class="cadastro" 
                                        ...
                                        <button name="botaoEnviar" id="botaoEnviar" type="submit"  class="btn btn-primary rounded-pill">Cadastrar Cliente</button>
                                    </div>
