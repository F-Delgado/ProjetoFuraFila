...
public class Autenticar {
    ...
    private final String client_id = "" ; //Insira aqui o client_id;
    private final String client_secret = ""; //Insira aqui o client_secret
    ...
    public String geraToken() {
        ...
        try {
            ...
            System.setProperty("javax.net.ssl.keyStore", "Aqui inisira o caminho do certificado p12");
